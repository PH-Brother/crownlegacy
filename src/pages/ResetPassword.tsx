    ...
    return (
      <div
        ...
        <div className="relative z-10 flex w-full max-w-[360px] flex-col items-center text-center">
          ...
          <p
            className="text-[13px] sm:text-sm text-center mb-5 animate-[fadeInUp_300ms_ease-out_160ms_both]"
            style={{ color: "hsl(var(--foreground) / 0.85)" }}>
            Aguarde enquanto validamos seu link de recuperação.
          </p>
          <Loader2 className="h-8 w-8 animate-spin" style={{ color: "hsl(var(--accent-light))" }} />
        </div>
      </div>
    );
  }
        ...
        <div
          ...
          <form onSubmit={handleReset} className="space-y-3">
            <div className="space-y-1.5">
              <label htmlFor="new-password" className="text-xs font-medium" style={{ color: "hsl(var(--foreground) / 0.7)" }}>
                Nova senha
              </label>
            ...
            <div className="space-y-1.5">
              <label htmlFor="confirm-password" className="text-xs font-medium" style={{ color: "hsl(var(--foreground) / 0.7)" }}>
                Confirmar senha
              </label>
              <input
                id="confirm-password"
