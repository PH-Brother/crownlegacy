...
import { Crown, Check, X, Loader2, AlertTriangle, RefreshCw } from "lucide-react";
...
export default function Planos() {
  ...
  const { assinatura, loading, error, isPremium, checkoutLoading, portalLoading, iniciarCheckout, abrirPortalCliente, refetch } = useAssinatura();
  ...
  return (
    <div className="mx-auto max-w-4xl px-4 py-6 space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              ...
              {!isPremium && <Badge variant="secondary" className="text-xs">Seu plano atual</Badge>}
            </div>
        ...
        {/* Premium Mensal */}
        <Card className="border-accent/40 shadow-lg shadow-accent/10 relative">
          <div className="absolute -top-3 left-1/2 -translate-x-1/2">
            <PremiumBadge text="Mais popular" size="sm" />
          </div>
          <CardHeader className="pb-3 pt-6">
            <CardTitle className="text-base">Premium Mensal</CardTitle>
            <p className="text-2xl font-bold text-foreground font-mono">US 9,90/mês/mês
        ...
        <Card className="border-primary/30">
          <CardHeader className="pb-3">
            ...
            <p className="text-2xl font-bold text-foreground font-mono">US 99,90/ano/ano
