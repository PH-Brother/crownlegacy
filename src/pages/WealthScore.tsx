...
export default function WealthScore() {
  ...
  const handleNext = () => {
    if (currentQ < QUESTIONS.length - 1) setCurrentQ((p) => p + 1);else
    calculateScore();
  };
    ...
    <div
      ...
      <div className="relative z-10 flex flex-col items-center w-full max-w-[600px] py-8 sm:py-12 min-h-screen">
        ...
        <img
          ...
          className="w-[100px] h-[100px] sm:w-[120px] sm:h-[120px] lg:w-[140px] lg:h-[140px] mb-4 animate-[fadeInScale_300ms_ease-out_both] rounded-3xl object-cover"
          loading="lazy" src="/lovable-uploads/02394429-4a2c-4414-a719-434f68d0e0c5.png" />
