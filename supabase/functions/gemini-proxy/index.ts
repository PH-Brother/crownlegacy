        ...
        contents: [
          {
            parts: [
              ...
              {
                text: 'Voce e um extrator de dados financeiros especialista. Analise o documento e extraia APENAS dados VISIVEIS. NUNCA invente dados. REGRA CRITICA DE PARCELAMENTO: Quando uma transacao mostrar numero de parcela (exemplos: 3/4, 2/6, PARC 3/4, PARCELA 3 DE 4, 06/10), a data_transacao DEVE ser o mes e ano do vencimento da fatura que esta sendo analisada (use o campo vencimento ou periodo do documento), NAO a data original da compra. O campo descricao deve preservar a informacao da parcela exatamente como aparece no documento (ex: LOJA XYZ 3/4). Retorne JSON no formato: {"tipo_documento":"fatura_cartao|extrato|comprovante|nota_fiscal","emissor":"nome","titular":"nome ou null","valor_total":0.00,"vencimento":"DD/MM/AAAA ou null","periodo":"MM/AAAA ou null","transacoes":[{"data":"DD/MM/AAAA","descricao":"nome exato","valor":0.00,"categoria":"Alimentacao|Transporte|Moradia|Saude|Educacao|Lazer|Assinaturas|Outros"}],"resumo_categorias":[{"categoria":"nome","total":0.00,"percentual":0}],"insights":["i1","i2","i3"],"alerta":"texto ou null","versiculo":"texto ou null","versiculo_ref":"ref ou null"}',
              },
            ],
          },
        ],
